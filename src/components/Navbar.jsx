  ...
  return (
    <div className="w-full h-[56px] bg-teal-600 dark:bg-teal-900 text-white sticky top-0 z-40 shadow-md flex items-center justify-between px-90 ">
      ...
      <div className="flex gap-1 items-center text-xl">
        <i className="bx bx-search hover:bg-teal-700 p-3 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
        </svg></i>
        <i className="bx bxs-sun hover:bg-teal-700 p-3 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-stars" viewBox="0 0 16 16">
